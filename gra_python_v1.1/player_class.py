...
class Player:
    def __init__(self, app, pos):
        ...
        self.speed = 2
        self.lives = 3
        self.live = pygame.image.load('zycie.png')
        self.player_graphic = pygame.image.load('gracz.png')
    ...
    def draw(self):
        self.app.screen.blit(self.player_graphic, (int(self.pix_pos.x) - self.app.cell_width//2, int(self.pix_pos.y) - self.app.cell_width//2))
#        pygame.draw.circle(self.app.screen, PLAYER_COLOUR, (int(self.pix_pos.x),
#                                                            int(self.pix_pos.y)), self.app.cell_width//2-2)

        # wyswietlanie żyć gracza
        for x in range(self.lives):
            self.app.screen.blit(self.live, (30 + 15*x, HEIGHT - 27))
