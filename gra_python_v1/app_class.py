...
########################### Koniec gry funkcje ################################
    ...
    def game_over_draw(self):
        ...
        self.draw_text("Koniec Gry", self.screen, [WIDTH//2, 100],  52, RED, "arial", centered=True)
        self.draw_text("Twój wynik to: {}".format(self.player.current_score), self.screen, [
                        WIDTH//2, 150],  52, WHITE, "arial", centered=True)
